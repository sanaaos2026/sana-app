...
def _seed_objects():
    ...
    catalog_descriptions = {
        ...
        "CONTENT_REFERENCE": "مراجع المحتوى العام المعتمدة لدعم الكتابة والتفسير دون اعتبارها دليل حالة.",
        "CONTENT_POLICY": "سياسات وضوابط المحتوى التي تحكم إنشاء ونشر واستخدام المعرفة.",
        "CONTENT_BACKLOG": "قائمة موضوعات وأفكار المحتوى المخطط لها ولم تُنفذ بعد.",
    }
